...
## How to Use These Diagrams in Your GitHub Repo

### 1. Copy to Markdown Files

Create a new file: `docs/UML_DIAGRAMS.md` and paste all diagrams.

### 2. Render on GitHub

These Mermaid diagrams will automatically render on GitHub when you view the markdown file.

### 3. Generate PNG Images (Optional)
...
mmdc -i EXIT_UML_DIAGRAMS.md -o diagrams/
```

### 4. Include in README

Reference diagrams in your main README:

```markdown
## System Architecture

See detailed UML diagrams: [docs/UML_DIAGRAMS.md](docs/UML_DIAGRAMS.md)

- [Overall System Architecture](#1-overall-system-architecture)
- [User Journey Flow](#2-user-journey-flow-onboarding--mastery)
- [Core Loop State Machine](#3-core-loop-state-machine-signal--static)
```

---

**These diagrams cover:**
1. ✅ Overall system architecture with all components
2. ✅ Complete user journey from onboarding to mastery
3. ✅ Signal & Static core loop with all states
4. ✅ Level progression with upgrade/downgrade logic
5. ✅ Quest selection algorithm with all filters
6. ✅ Dopamine Menu smart matching system
7. ✅ Pattern Break system with snooze logic
8. ✅ Streak & Grace Mode with repair mechanics

All user behaviors and gamification mechanics are accounted for!
